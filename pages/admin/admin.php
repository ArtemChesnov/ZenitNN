...
// Auto logout (при закрытии вкладки)
...
<body class="page admin-page">
    ...
    <?php else: ?>
        <div class="admin-panel">
            ...
            <form id="upload-form" enctype="multipart/form-data" class="admin-panel__form">
                ...
                <input class="admin-panel__form-input" type="text" placeholder="Заголовок" name="title" id="title" required>

                <label for="text" class="admin-panel__form-label">Текст новости</label>
                <textarea class="admin-panel__form-textarea" name="text" id="text" placeholder="Текст новости" rows="5"
                    required></textarea>
        ...
        <div class="admin-panel__progress" id="progressWrapper">
    ...
    <script>
        window.addEventListener("beforeunload", () => {
            navigator.sendBeacon(window.location.href, new URLSearchParams({ auto_logout: 1 }));
        });
    </script>
</body>
